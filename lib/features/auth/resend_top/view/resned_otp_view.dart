...
class ResnedOtpView extends StatelessWidget {
  const ResnedOtpView({super.key});
        ...
        child: Padding(
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                AuthHeader(
                  headerTitle: StringsManager.resendOtpTitle,
                  headerSubTitle: StringsManager.resendOtpSubTitle,
                ),
                MakeSpacke(
                  height: AppSize.s100,
                ),
